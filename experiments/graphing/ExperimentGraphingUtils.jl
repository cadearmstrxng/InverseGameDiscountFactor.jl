...
function process_and_graph_crosswalk_results(
    ...
    # Save plot
    save(joinpath(output_prefix, "crosswalk_comparison.png"), fig)
    save(joinpath(pdf_dir, "crosswalk_comparison.pdf"), fig, pt_per_unit=1, pt_per_inch=72)
    ...
    if !isnothing(po_file_path)
        ...
        save(joinpath(output_prefix, "crosswalk_fo_comparison.png"), fig_fo)
        save(joinpath(pdf_dir, "crosswalk_fo_comparison.pdf"), fig_fo, pt_per_unit=1, pt_per_inch=72)
        ...
        save(joinpath(output_prefix, "crosswalk_po_comparison.png"), fig_po)
        save(joinpath(pdf_dir, "crosswalk_po_comparison.pdf"), fig_po, pt_per_unit=1, pt_per_inch=72)
        ...
        save(joinpath(output_prefix, "crosswalk_baseline_comparison.png"), fig_b)
        save(joinpath(pdf_dir, "crosswalk_baseline_comparison.pdf"), fig_b, pt_per_unit=1, pt_per_inch=72)
        ...
        save(joinpath(output_prefix, "crosswalk_our_method_comparison.png"), fig_m)
        save(joinpath(pdf_dir, "crosswalk_our_method_comparison.pdf"), fig_m, pt_per_unit=1, pt_per_inch=72)
    end
